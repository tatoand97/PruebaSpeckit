...
`dotnet-sdd` 1.0.1, `dotnet-sdd-feature` 0.1.0, and `dotnet-sdd-guard` 1.0.0 are local
...
specify bundle init "./dotnet-sdd-bundle/dist/dotnet-sdd-1.0.0.zip" --integration copilot
```
