...
| `dotnet-sdd-feature` | 0.1.0 | `artifacts/dotnet-sdd-feature-0.1.0.yml` | `b7eee5091124bac50971378bc3f3e5bf261a8d964e4ca59a8961887fa74b5c00` | `https://github.com/tatoand97/PruebaSpeckit/releases/download/__RELEASE_TAG__/dotnet-sdd-feature-0.1.0.yml` |
...
| `dotnet-sdd-bundle` | 1.0.0 | `artifacts/dotnet-sdd-1.0.0.zip` | `e6eacf72d74298eb707cdfe35a69451e13a0f2fccded1e564b63829f0fb43ef7` | `https://github.com/tatoand97/PruebaSpeckit/releases/download/__RELEASE_TAG__/dotnet-sdd-1.0.0.zip` |
...
| Workflow | `https://raw.githubusercontent.com/tatoand97/PruebaSpeckit/main/distribution/catalogs/workflows.json` | 1.0 | `dotnet-sdd-feature` | 0.1.0 | `install_allowed: true`, written automatically by `catalog add` |
...
| Bundle | `https://raw.githubusercontent.com/tatoand97/PruebaSpeckit/main/distribution/catalogs/bundles.json` | 1.0 | `dotnet-sdd` | 1.0.0 | `install-allowed` through `--policy` |
...
| Workflow resolution | LOCAL PASS | `search`, `info`, and `add` installed `dotnet-sdd-feature` 0.1.0 from its catalog. |
...
| Provenance | **FAIL** | Bundle installation rolls back and does not create a successful `dotnet-sdd` 1.0.0 provenance record. |
...
| `dotnet-sdd-feature` | 0.1.0 | 0.1.0 PASS | Not installed |
| `dotnet-sdd-guard` | 1.0.0 | 1.0.0 PASS | Not retained; bundle transaction failed |
| bundle | 1.0.0 | Resolution metadata PASS | Provenance not recorded |

The required final state:

```text
dotnet-sdd          1.0.1
dotnet-sdd-feature  0.1.0
...
5. confirm the three exact component versions, mandatory `after_implement` hook,
   Copilot materialization, and bundle 1.0.0 provenance without `--dev`, local paths,
